...
def main():
    """Main function for REINDEER GUI."""
    st.set_page_config(
        page_title="REINDEER",
        page_icon=r".\reindeer\logo\title_logo.png",
        layout="centered",
    ...
    st.image(r".\reindeer\logo\Logo.png")
    ...
    **[Ref](https://www.frontiersin.org/articles/10.3389/fchem.2021.753002/full)**"""
    ...
    if ecif_condition:
        with st.spinner("Please wait..."):
            ...
            ecif_fv.generate_features(n_jobs=n_jobs)
    ...
    if ms_oic_condition:
        with st.spinner("Please wait..."):
            ...
            ms_oic_fv.generate_features(n_jobs=n_jobs)
